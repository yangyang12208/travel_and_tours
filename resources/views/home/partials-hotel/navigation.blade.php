            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                {{-- <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item"><a class="nav-link fs-5 text-primary" href="#about-us">About Us</a></li>
                        <li class="nav-item"><a class="nav-link fs-5 text-primary" href="#contact-us">Contact Us</a></li>
