       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                <div class="header-text mb-4">
                     <h2><span class="text-primary">Register</span> your account</h2>
                ...
                <form id="register-form" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" name="firstname" class="form-control form-control-lg bg-light fs-6" placeholder="Firstname">
                    </div>
              
                
                    <div class="input-group mb-3">
                        <input type="text" name="lastname" class="form-control form-control-lg bg-light fs-6" placeholder="Lastname">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password_confirmation" class="form-control form-control-lg bg-light fs-6" placeholder="Confirm Password">
                    </div>
                ...
                <div class="row">
                    <small>Already Have Account?<a href="{{ route('login') }}">Log in</a></small>
                </div>
          </div>
       </div> 
      </div>
