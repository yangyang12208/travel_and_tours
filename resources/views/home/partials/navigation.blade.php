...
<div class="container-fluid p-0"  data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
    <div class="row no-gutters">
        <div class="position-relative">
            <img src="{{ asset('images/tagaytay.jpg') }}" class="img-fluid custom-image w-100 shadow-img" alt="...">
            <div class="position-absolute top-50 start-50 translate-middle text-white text-center">
                <h1 class="display-4 text-shadow"><span style="color: yellow;" class="fw-bold">Philippines</span> <span style="color: red;" class="fw-bold">Vacation</span> <span style="color: blue;" class="fw-bold">Packages</span></h1>
                <p class="lead text-shadow">Explore the best selection of vacation packages in the Philippines. With all the details arranged for you in advance, you can enjoy a stress-free holiday at top beaches and islands in the country. Book now for the best rates!</p>
            </div>
        </div>
    </div>
</div>